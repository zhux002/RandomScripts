...
figure
boxplot([data_lettucegroup_lettuce.',data_lettucegroup_cucumber.'],'Labels',{'Lettuce','Cucumber'})
title('Consumption of vegetables for a 24 hour period for Lettuce Group')
xlabel('Food type')
ylabel('Amount consumed (gram)')

figure
boxplot([data_cucumbergroup_lettuce.',data_cucumbergroup_cucumber.'],'Labels',{'Lettuce','Cucumber'})
...
title('Consumption of vegetables for a 24 hour period for Cabbage Group')
xlabel('Food type')
ylabel('Amount consumed (gram)')
